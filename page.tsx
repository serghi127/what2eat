...
import { ChevronLeft, ChevronRight, Clock, Users, DollarSign, Zap, Leaf, Target, ShoppingCart, X, Check, Plus, Minus } from 'lucide-react';
...
function App() {
  ...
  const generateMealPlan = () => {
    ...
    DAYS.forEach((day, dayIndex) => {
      plan[day] = {};
      MEALS.forEach(meal => {
        const availableRecipes = SAMPLE_RECIPES[meal];
                ...
                <div>
                  ...
                  <div className="flex items-center space-x-2">
                    <input
                      ...
                      onChange={(e) => setPreferences(prev => ({...prev, caloriesGoal: parseInt(e.target.value)}))}
                      className="flex-1"
                    />
                ...
                <div>
                  ...
                  <div className="flex items-center space-x-2">
                    <input
                      ...
                      onChange={(e) => setPreferences(prev => ({...prev, proteinGoal: parseInt(e.target.value)}))}
                      className="flex-1"
                    />
              ...
              <div>
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <input
                    ...
                    onChange={(e) => setPreferences(prev => ({...prev, timePerDay: parseInt(e.target.value)}))}
                    className="flex-1"
                  />
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) => setPreferences(prev => ({...prev, specificCravings: e.target.value}))}
                />
              </div>
            </div>
          )}
